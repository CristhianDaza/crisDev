...
<template>
  <div id="experience-section" class="w-full">
    <div class="text-center mb-16">
      <h2
        class="mb-4 text-4xl md:text-5xl font-bold bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] bg-clip-text text-transparent"
    ...
    <div class="relative max-w-5xl mx-auto">
      <div
        class="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full transition-all duration-1000 bg-gradient-to-b from-[var(--primary)] to-[var(--accent)] transform-origin-top"
      ...
      >
        ...
        >
          ...
          >
            <div
              class="p-6 rounded-2xl backdrop-blur-sm border transition-all duration-300 hover:scale-105 hover:shadow-2xl group"
            ...
            >
              <div class="mb-3 flex flex-col gap-2" :class="index % 2 === 0 ? 'md:items-end' : 'md:items-start'">
                ...
                <div
                  class="inline-block px-3 py-1 rounded-full text-xs font-medium transition-colors"
              ...
              <div class="flex flex-wrap gap-2" :class="index % 2 === 0 ? 'md:justify-end' : 'md:justify-start'">
                <span
                  ...
                  :key="tech"
                  class="px-3 py-1 rounded-full text-xs font-medium transition-all duration-300 hover:scale-110"
                  style="background: var(--chip); color: var(--text); opacity: 0.9;"
                >
                  {{ tech }}
                </span>
              </div>
        ...
        >
          <div
            class="w-4 h-4 rounded-full border-4 transition-all duration-300 hover:scale-150"
            style="background: var(--surface); border-color: var(--primary);"
          >
            <div
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none -z-10">
      <div
        class="absolute top-1/4 -left-32 w-96 h-96 rounded-full opacity-5 blur-3xl"
        style="background: radial-gradient(circle, var(--accent), transparent 70%);"
      />
      <div
        class="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full opacity-5 blur-3xl"
