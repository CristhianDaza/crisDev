...
export const projects = [
  {
    ...
    fullDescription: 'projects.bookMemory.fullDescription',
    technologies: ['Vue 3', 'TypeScript', 'Pinia', 'Vue Router', 'Firebase', 'Tailwind CSS', 'Vue I18n', 'PWA'],
    image: '/images/projects/bookMemory.png',
    imageDetail: '/images/projects/bookMemory_mobile.png',
    projectUrl: 'https://bookmemory.cris-dev.com/',
    githubUrl: 'https://github.com/CristhianDaza/book-memory',
    featured: true,
    date: '2026',
    highlights: [
      'projects.bookMemory.highlights.highlight1',
      'projects.bookMemory.highlights.highlight2',
      'projects.bookMemory.highlights.highlight3',
      'projects.bookMemory.highlights.highlight4',
      'projects.bookMemory.highlights.highlight5',
    ],
  },
  {
    id: 8,
    title: 'projects.streakCalendar.title',
    shortDescription: 'projects.streakCalendar.shortDescription',
    fullDescription: 'projects.streakCalendar.fullDescription',
    technologies: ['HTML', 'CSS', 'JavaScript ES Modules', 'PWA'],
    image: '/images/projects/streakCalendar.png',
    imageDetail: '/images/projects/streakCalendar_mobile.png',
    projectUrl: 'https://calendar.cris-dev.com/index.html',
    githubUrl: 'https://github.com/CristhianDaza/streak-calendar',
    featured: true,
    date: '2026',
    highlights: [
      'projects.streakCalendar.highlights.highlight1',
      'projects.streakCalendar.highlights.highlight2',
      'projects.streakCalendar.highlights.highlight3',
      'projects.streakCalendar.highlights.highlight4',
      'projects.streakCalendar.highlights.highlight5',
    ],
  },
  {
    id: 4,
